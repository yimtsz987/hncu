...
public class PageUtils {
    ...
    public static String pageStr (PageInfo pageInfo) {
        ...
        StringBuilder sb = new StringBuilder("<ul class=\"pagination pagination-lg pull-right\">");
        //判断当前页是不是首页
        ...
        sb.append("<li class=\"disabled controls\">当前第 ");
        sb.append("<input class=\"page-input\" type=\"text\" maxLength=\"6\" value=\"");
