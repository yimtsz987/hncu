	...
	<body>
		<div class="page-content">
			<div class="page-search">
				...
				<form:form id="searchForm" modelAttribute="teacherOpenTitle" action="${ctx}/teacher/scheduleList" method="post" cssClass="form-horizontal">
				...
				<table class="table table-hover table-bordered table-striped">
					...
					<c:forEach items="${teacherSchedulePageInfo.list}" var="schedule">
						<tr>
							...
							<td>
								<a href="${ctx}/teacher/scheduleInfoList?schedule.reportId=${schedule.openTitle.id}&schedule.studentId=${schedule.user.id}"  class="btn btn-xs btn-primary" >查看详情</a>
							</td>
						</tr>
					</c:forEach>
					</tbody>
