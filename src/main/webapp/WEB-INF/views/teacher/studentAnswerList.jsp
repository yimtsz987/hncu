	...
	<body>
		<div class="page-content">
			<div class="page-search">
				...
				<form:form id="searchForm" modelAttribute="teacherOpenTitle" action="${ctx}/teacher/studentAnswerList" method="post" cssClass="form-horizontal">
					<input id="pageNum" name="pageNum" type="hidden" value="${teacherAnswerPageInfo.pageNum}"/>
					<input id="pageSize" name="pageSize" type="hidden" value="${teacherAnswerPageInfo.pageSize}"/>
			...
			<div class="table-responsive table-custom">
				<table class="table table-hover table-bordered table-striped">
					...
					<tbody  id="tbodyId">
					<c:forEach items="${teacherAnswerPageInfo.list}" var="studentAnswer">
						<tr>
							<td><input type="checkbox" name="node"/></td>
							<td>${studentAnswer.user.student.node}</td>
			...
			<div class="page-info">
				${gpms:pageStr(teacherAnswerPageInfo)}
			</div>
		</div>
	</body>
<script type="text/javascript">
