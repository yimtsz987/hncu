	...
	<body>
		<div class="page-content">
			<div class="page-search">
				...
				<form:form id="searchForm" modelAttribute="teacherMarking" action="${ctx}/teacher/reviewInfoList" method="post" cssClass="form-horizontal">
					...
					<c:forEach items="${teacherReviewPageInfo.list}" var="review">
						<tr>
							...
							<td>
								...
								<c:if test="${review.marking.state ne 1}">
									<a href="${ctx}/teacher/reviewCheck?id=${review.marking.id}" class="btn btn-xs btn-primary">查看评阅</a>
								</c:if>
							</td>
						</tr>
					</c:forEach>
