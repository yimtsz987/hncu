		...
		<div class="page-content">
			<div class="col-lg-12">
				<div class="center-block" style="width: 750px; background: #c5e1d5;box-shadow: 2px 2px 10px #696969">
					...
					<p class="number">成绩单编号：<span>${gpms:queryUserById(schoolReport.studentId).student.schoolReport.reportId}</span></p>
					...
					<div class="info">
						<div class="infos">
							<p>姓&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;名&nbsp;:&nbsp;<span>${gpms:queryUserById(schoolReport.studentId).name}</span></p>
							<p>学&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;号&nbsp;:&nbsp;<span>${gpms:queryUserById(schoolReport.studentId).student.node}</span></p>
							<p>院&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;系&nbsp;:&nbsp;<span>${gpms:queryUserById(schoolReport.studentId).student.department.name}</span></p>
							<p>课&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;题&nbsp;:&nbsp;<span>${gpms:queryUserById(schoolReport.studentId).student.titleName}</span></p>
							<p>指导老师&nbsp;:&nbsp;<span>${gpms:queryUserById(schoolReport.studentId).student.teacherName}</span></p>
						</div>
						<div class="photo">
							<img src="${ctxStatic}/${gpms:queryUserById(schoolReport.studentId).headerPic}" width="170px" height="200px" />
						</div>
					</div>
					<div class="results">
