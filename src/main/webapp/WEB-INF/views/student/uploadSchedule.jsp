...
<head>
	<%@ include file="/WEB-INF/views/include/head.jsp"%>
		<title>设计和论文撰计划报告上传</title>
	</head>
	<body>
		<div class="page-content">
			<ul class="nav nav-tabs">
				<li class="active">
					<a href="#">设计和论文撰计划报告上传</a>
				</li>
			</ul>
			    <form:form action="${ctx}/student/uploadScheduleReport" enctype="multipart/form-data" method="post" cssClass="form col-lg-12" cssStyle="margin-top: 50px;" id="form-id" modelAttribute="schedule">
					<form:hidden path="id"/>
