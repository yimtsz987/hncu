...
<div class="page-content">
	<div class="info-wrap">
		<div class="info-left">
			...
			<div class="info-text">
				<p>${user.student.node}</p>
				<p>${user.name}</p>
				<p>${gpms:getDictLabel(user.sex, 'sex')}</p>
				<p>${user.student.department.name}</p>
				<p>${user.student.major.name}</p>
			</div>
		...
		<div class="info-right">
			<div class="info-main form-horizontal">
				<div class="form-group">
					...
					<div class="col-lg-6 col-xs-6 col-sm-6 has-feedback">
						<div class="info-right-text">${user.student.node}</div>
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-lg-6 col-xs-6 col-sm-6 has-feedback">
						<div class="info-right-text">${user.student.department.name}</div>
					</div>
				</div>
				<div class="form-group">
					<label class="control-label col-lg-3 col-xs-3 col-sm-3 label-size">专&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;业:</label>
					<div class="col-lg-6 col-xs-6 col-sm-6 has-feedback">
						<div class="info-right-text">${user.student.major.name}</div>
					</div>
				</div>
				<div class="form-group">
					<label class="control-label col-lg-3 col-xs-3 col-sm-3 label-size">班&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;级:</label>
					<div class="col-lg-6 col-xs-6 col-sm-6 has-feedback">
						<div class="info-right-text">${user.student.classes}</div>
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-lg-6 col-xs-6 col-sm-6 has-feedback">
						<div class="info-right-text">${user.address}</div>
					</div>
				</div>
				<div class="form-group">
					<label class="control-label col-lg-3 col-xs-3 col-sm-3 label-size">年&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;级:</label>
					<div class="col-lg-6 col-xs-6 col-sm-6 has-feedback">
						<div class="info-right-text">${user.student.year}</div>
					</div>
				</div>
				<div class="form-group">
					<label class="control-label col-lg-3 col-xs-3 col-sm-3 label-size">指导老师:</label>
					<div class="col-lg-6 col-xs-6 col-sm-6 has-feedback">
						<div class="info-right-text">${user.student.teacherName}</div>
					</div>
				</div>
				<div class="form-group">
					<label class="control-label col-lg-3 col-xs-3 col-sm-3 label-size">课&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;题:</label>
					<div class="col-lg-6 col-xs-6 col-sm-6 has-feedback">
						<div class="info-right-text">${user.student.titleName}</div>
					</div>
				</div>
				<div class="form-group">
			...
			<div class="center-block" style="width:48%;">
				<a href="${ctx}/student/studentInfoEdit" class="btn btn-primary">修改信息</a>
			</div>
		</div>
	</div>
</div>
