	...
	<body>
		<div class="page-content">
			...
			<div class="table_a center-block">
				<div class="page-title">课题：${gpms:getUser().student.titleName} ----  ${gpms:getUser().name}</div>
				<div class="table_1 table-responsive table-custom ">
					<table class="table table-hover table-bordered table-striped">
						...
						<tr>
							...
							<th>
								<a href="${ctx}/student/downloadStudentQuestion?id=${marking.id}&studentCheckStr=${marking.studentCheckStr}" class="btn btn-xs btn-primary">下载</a>
							</th>
						</tr>
						<c:if test="${marking.tuploadFileOldName != null}">
							<tr>
								...
								<th>
									<a href="${ctx}/student/downloadTeacherQuestion?id=${marking.id}&teacherCheckStr=${marking.teacherCheckStr}" class="btn btn-xs btn-primary">下载</a>
								</th>
							</tr>
						</c:if>
						</tbody>
