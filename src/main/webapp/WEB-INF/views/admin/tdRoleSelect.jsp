...
<div class="logintop">    
    ...
    <ul class="loginlist">
    <li style="margin-left:0px"><a href="login1.html"><img src="${ctxStatic}/img/jszc.png" width="135px" height="135px"  alt="教师"/><p>教师</p></a></li>
    <li style="margin-right:0px; float: right;"><a href="login2.html"><img src="${ctxStatic}/img/01.png"  alt="教研室主任"/><p>教研室主任</p></a></li>
    </ul>
    </div>
    </div>
