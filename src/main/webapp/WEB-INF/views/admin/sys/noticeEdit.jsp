...
<html>
	...
	<body>
		<div class="page-content">
			...
			<form:form action="${ctx}/notice/saveNotice" enctype="multipart/form-data" method="post" cssClass="form-horizontal" id="form-id" modelAttribute="notice">\
				<form:hidden path="id" />
			   <div class="form-group control-group">
				...
				<div class="form-group control-group">
					<label  class="control-label col-lg-2 col-xs-2 col-sm-2">接收角色:</label>
					<div class="col-lg-3 col-xs-3 col-sm-3 has-feedback">
						<form:checkboxes path="roleIdList"  items="${roleList}" itemLabel="name" itemValue="id" />
					</div>
					<div class="form-message control-label col-lg-2 col-xs-2 col-sm-2">
						<span style="padding-left: 20px;" class="Validform_checktip pull-left">接收角色</span>
					</div>
				</div>
